...
use zigzag_core::action::ActionDef;
use zigzag_core::domain::{Project, Session, WorktreeEntry};
use zigzag_tui::{ProjectEntry, WorkflowInfo};
...
pub(crate) fn build_project_entry(
    ...
    zigzag_core::activity::sort_sessions_by_recent_attach(&mut sessions, activity);
...
mod tests {
    ...
    use zigzag_autopilot::dsl::Trigger;
    use zigzag_core::domain::Transport;
